...
import dev.macrohq.meth.util.ScoreboardUtil
...
class LocationTracker : AbstractFeature() {
  override val featureName: String = "LocationTracker"
  override val isPassiveFeature: Boolean = true
  override var forceEnable: Boolean = true
  override var enabled: Boolean = true

  companion object {
    private var instance: LocationTracker? = null
    fun getInstance(): LocationTracker {
      if (instance == null) instance = LocationTracker()
      return instance!!
    }
  }
  ...
  enum class SubLocation(val locName: String) {
    ...
    // <editor-fold desc="Farming Islands and Desert Settlement">
    The_Barn("The Barn"),
    Windmill("Windmill"),
